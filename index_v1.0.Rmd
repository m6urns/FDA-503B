...
#   mutate(Active = "Vancomycin Hydrochloride") %>%
...
facility_product_count <- read_csv("~/Desktop/FDA-503B/data/facility_product_count.csv")
product_list_graphics <- read_csv("~/Desktop/FDA-503B/data/product_list.csv")
```
...
[FDA 503B Product List](./data/Raw FDA Data.xlsx)
